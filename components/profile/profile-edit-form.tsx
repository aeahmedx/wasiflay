...
export function ProfileEditForm({
   ...
   * Nullable now.
   *
   * Onboarding stopped asking for a region, so this is null for anyone
   * who joined after that. Reading .length on it crashed the page —
   * defaulting to an empty string keeps the select on its placeholder
   * and the existing validation works unchanged.
   */

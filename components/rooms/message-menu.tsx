  ...
  return (
      <div ref={ref} className="relative shrink-0">
        <button
            ...
            aria-expanded={open}
            className="rounded px-2 py-0.5 text-base leading-none text-stone-400 hover:bg-stone-100 hover:text-stone-700"
        >
          ⋯
        </button>
              ...
              {mode === "menu" ? (
                  ...
                  <>
                    ...
                    {REASONS.map((r) => (
                        <label
                            key={r}
                            className="flex items-center gap-2 rounded px-2 py-1 text-sm text-stone-700 hover:bg-stone-100"
                        >
                          <input
                              type="radio"
